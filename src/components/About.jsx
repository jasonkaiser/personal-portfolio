    ...
    <section id="aboutme" className="relative overflow-hidden">
      <div className="relative z-10 flex flex-col items-center pt-10">
        ...
        <div className="rounded-3xl p-6 max-w-5xl mx-auto w-full flex flex-col md:flex-row items-center gap-15 lg:mb-30">
            ...
            <div className="flex gap-3 mt-3 max-sm:mt-0 max-sm:mb-1">
              {topButtons.map((item) => (
                <button
                  ...
                  className={`purple-button font-bold transition-all duration-300 ease-in-out ${
                    aboutItem === item.id
          ...
          {/* Right side */}
          <div className="h-90 w-full md:w-1/2 flex flex-col items-center text-center max-sm:items-center bg-gray-100 shadow p-8 rounded-3xl hover:shadow-xl transition-shadow duration-300">
          <h1
            className="text-2xs font-semibold font-mono capitalize mb-20 bg-purple-300/40 w-30 rounded-full border text-purple-600 border-purple-600 py-2 relative underline-line"
          >
            <span
            ...
            <p
              className={`text-gray-600 transition-opacity duration-200 ease-in-out ${
                fade ? "opacity-100" : "opacity-0"
              }`}
            >
